...
### Classic Unix IO Models
 ...
 ### IO Patterns (is is good to mentioned here, maybe better to introduced this in the place which use it, e.g: problem section to explain thread-based pattern, C10K solution to describe the others two)
