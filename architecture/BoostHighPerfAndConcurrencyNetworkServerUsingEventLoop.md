...
###nonblocking in conjunction with synchonized-demultipluxer(selector,e.g: select, poll and epoll) 
...
### nonblocking in conjunction with asynchornized-demultipluxer(e.g: SIGIO notification)
