...
C10K was raised based on condition/situation(both hardware and whole interenet ecosystem) at that time..Today, C10K problem itself is not a problem anymore, people are resolving the challenge of C10M, but the insights/solution for C10K as the foundation of so many perfect softwares still enlighten us and point us to a way forward. 
