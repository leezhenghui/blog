...
Inspired by the _**data selector**_ idea from hardware side, the `I/O multpliexing` is worked out to increase the amount of file descriptors handling within a certain amount of thread/process via the efficient selector mechanisms provided by operating system.
