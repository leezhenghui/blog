...
> Note: If you are familiar with these five I/O models under Unix-like operating system, you can skip the content about these five I/O types explanations. But I strongly suggest you to read the section 1.6 and section 1.7 which are aimed to clarify some key terminologies which are used frequently in this writing. IMO, these terminologies are used widely in the purposes of introducing I/O behaviors, but people use them ususally from different point of views,  not always comply with POSIX standard. It could be really helpful to make us on the same page of these terminologies before we go forward.
