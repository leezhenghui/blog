...
> Multiplex model actually provide a efficent synchronous approach to select the readiness events among file descriptors, compare to pure nonblocking model, and then avoid waste processor cycles on the polling of each file descriptor status.
